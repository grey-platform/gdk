...
void *TranslateClause(Translator *tr, _FILE *f_text, const void *vp_input, int *tone, char **voice_change);
int ReadClause(Translator *tr, _FILE *f_in, char *buf, short *charix, int *charix_top, int n_buf, int *tone_type, char *voice_change);
...
extern _FILE *f_trans;		// for logging
extern _FILE *f_logespeak;
